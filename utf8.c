/*	This file is part of the auxiliaries library.
	...
	$Id: utf8.c,v 1.16 2020-11-06 17:15:58 dick Exp $
*/
...
process_first_byte(utf8_box *u, int byte) {
	...
	*/
	...
	case 0000: case 0100:
		/* ASCII: we are done */
		u->_size = 1;
		u->code_point = byte;	/* no sign extension for ASCII */
